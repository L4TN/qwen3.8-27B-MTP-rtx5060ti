...
Write-Host "Starting IQ4_XS 32K Q4 on http://127.0.0.1:1234 - VRAM 15347 MiB (94.1%)" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 32768 | KV q4_0 | MTP n=3 | threads 6" -ForegroundColor DarkGray
