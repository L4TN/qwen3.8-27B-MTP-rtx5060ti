@echo off
REM Start IQ3_XXS 150K Q4 - Extended Context (sweet spot 15.0GB / 16.3GB)
...
nvidia-smi
echo Starting IQ3_XXS 150K Q4 on http://127.0.0.1:1234 - VRAM 15.0GB / 16.3GB
echo Note: 150K sweet spot; 94K-250K validated, above 150K prompt drops
