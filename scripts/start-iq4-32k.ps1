...
Write-Host "Starting IQ4_XS 32K Q8 on http://127.0.0.1:1234 - VRAM 15.5GB / 16.3GB (15843 MiB) - safe" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 32768 | KV q8_0 | MTP n=3 | threads 6" -ForegroundColor DarkGray
Write-Host "Note: 32K is safe market standard; 45K (15.9GB) validated as max for IQ4 Q8" -ForegroundColor DarkGray
