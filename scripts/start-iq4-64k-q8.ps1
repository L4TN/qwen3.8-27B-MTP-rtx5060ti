# Start IQ4_XS 64000 q8_0 - OOM 64K
...
Write-Host "Starting IQ4_XS 64000 q8_0 - OOM 64K on http://127.0.0.1:1234" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 64000 | KV q8_0 | MTP n=3 | threads 6 | OOM expected" -ForegroundColor DarkGray
