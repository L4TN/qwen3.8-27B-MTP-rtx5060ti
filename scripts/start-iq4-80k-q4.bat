@echo off
REM Start IQ4_XS 80K Q4 LIMIT - Extended context (15844 MiB 97.1%)
...
nvidia-smi
echo Starting IQ4_XS 80K Q4 LIMIT on http://127.0.0.1:1234 - VRAM 15844 MiB (97.1%) - 44.07/43.85 t/s - max estavel
