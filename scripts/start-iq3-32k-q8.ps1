# Start IQ3_XXS 32768 q8_0 - baseline 32K Q8
...
Write-Host "Starting IQ3_XXS 32768 q8_0 - baseline 32K Q8 on http://127.0.0.1:1234" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 32768 | KV q8_0 | MTP n=3 | threads 6 | baseline Q8" -ForegroundColor DarkGray
