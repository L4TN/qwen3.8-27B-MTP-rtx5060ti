...
nvidia-smi
echo Starting IQ3_XXS 128K Q4 on http://127.0.0.1:1234 - VRAM 14.3GB / 16.3GB - safe (150K sweet spot 15.0GB)
echo Note: 128K is safe market standard; 150K sweet spot and 250K max validated
