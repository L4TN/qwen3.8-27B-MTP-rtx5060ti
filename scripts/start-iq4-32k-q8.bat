@echo off
REM Start IQ4_XS 32K Q8 - High Precision (safe 15.5GB / 16.3GB - market standard)
...
nvidia-smi
echo Starting IQ4_XS 32K Q8 on http://127.0.0.1:1234 - VRAM 15.5GB / 16.3GB - safe (45K max validated)
