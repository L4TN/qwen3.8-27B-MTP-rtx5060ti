# Start IQ3_XXS 32768 q4_0 - baseline 32K
...
Write-Host "Starting IQ3_XXS 32768 q4_0 - baseline 32K on http://127.0.0.1:1234" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 32768 | KV q4_0 | MTP n=3 | threads 6 | baseline vs IQ4" -ForegroundColor DarkGray
