# Start IQ4_XS 45K Q8 - High Precision (sweet spot 15.9GB / 16.3GB)
...
Write-Host "Starting IQ4_XS 45K Q8 on http://127.0.0.1:1234 - VRAM 15.9GB / 16.3GB (15963 MiB)" -ForegroundColor Green
