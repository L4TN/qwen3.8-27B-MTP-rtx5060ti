# Start IQ4_XS 80K Q4 - market 80K (15842 MiB 107/41) - below 90K limite
...
Write-Host "Starting IQ4_XS 80K Q4 on http://127.0.0.1:1234 - VRAM 15842 MiB 107/41" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 80000 | KV q4_0 | MTP n=3 | threads 6 | 80K OK - 90K limite 15854 MiB 107/46" -ForegroundColor DarkGray
