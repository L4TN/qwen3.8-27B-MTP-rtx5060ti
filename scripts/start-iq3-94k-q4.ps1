# Start IQ3_XXS 94K Q4 - (13873 MiB 85.1%)
...
Write-Host "Starting IQ3_XXS 94K Q4 on http://127.0.0.1:1234 - VRAM 13873 MiB (85.1%)" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 94208 | KV q4_0 | MTP n=3 | threads 6" -ForegroundColor DarkGray
