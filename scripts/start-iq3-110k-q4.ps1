# Start IQ3_XXS 110K Q4 - (14308 MiB 87.7%)
...
Write-Host "Starting IQ3_XXS 110K Q4 on http://127.0.0.1:1234 - VRAM 14308 MiB (87.7%)" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 110000 | KV q4_0 | MTP n=3 | threads 6" -ForegroundColor DarkGray
