# Start IQ4_XS 100000 q4_0 - OOM 100K
...
Write-Host "Starting IQ4_XS 100000 q4_0 - OOM 100K on http://127.0.0.1:1234" -ForegroundColor Green
Write-Host "Model: $MODEL | ctx 100000 | KV q4_0 | MTP n=3 | threads 6 | OOM expected" -ForegroundColor DarkGray
